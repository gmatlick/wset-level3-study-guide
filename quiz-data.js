...
const quizData = {
    viticulture: {
        ...
        questions: [
            ...
            },
            {
                ...
                correct: 2,
                explanation: "Veraison occurs in mid-summer when grapes begin to change color (from green to red/purple for black grapes, or yellow/gold for white grapes), soften, and accumulate sugar while acidity decreases."
            },
            {
            ...
            },
            {
                ...
                correct: 1,
                explanation: "Noble rot (Botrytis cinerea) requires specific conditions: humid misty mornings to encourage the fungus, followed by dry sunny afternoons to concentrate the grapes. This pattern is found in regions like Sauternes."
            },
            {
                ...
                correct: 0,
                explanation: "Winter pruning removes old, diseased wood and controls the number of buds for next season, managing yield and vine vigor. It's done when vines are dormant to minimize stress and disease risk."
            },
            {
                ...
                correct: 1,
                explanation: "Powdery mildew is a fungal disease that affects leaves, shoots, and grapes, appearing as white powdery growth. It thrives in warm, dry conditions and can reduce yield and quality if not controlled."
            },
            {
                q: "What is coulure?",
                options: [
                ...
                correct: 1,
                explanation: "Coulure (poor fruit set) occurs when flowering or pollination fails, resulting in many unfertilized flowers that don't develop into grapes. It's common with varieties like Merlot and Grenache in cool, wet, or windy conditions during flowering."
            },
            {
                ...
                correct: 1,
                explanation: "Pinot Noir requires a cool climate with a long, moderate growing season to develop its delicate flavors and aromatics. Too much heat makes it jammy and flabby; too cool prevents ripening."
            },
            {
                ...
                correct: 2,
                explanation: "Brix measures the dissolved solids (primarily sugars) in grape juice. It's used to determine ripeness and predict potential alcohol level. In Europe, Baumé or Oechsle scales are more common."
            },
            {
                ...
                correct: 1,
                explanation: "Organic viticulture uses copper and sulfur treatments (Bordeaux mixture) to combat fungal diseases, avoiding synthetic chemicals. Cover crops, compost, and natural pest management are also key practices."
            },
            {
                ...
                correct: 1,
                explanation: "Millerandage (hen and chickens) results in a bunch with both normal-sized berries and small seedless ones, often from poor pollination or coulure. It can concentrate flavors but reduces yield."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Cold currents like the Humboldt or Benguela."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is Compete with vines for water and nutrients, manage vigor, prevent erosion."
            },
            {
                ...
                correct: 2,
                explanation: "The correct answer is Below 0°C (32°F)."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Scott Henry or Lyre."
            }
        ]
    },
        ...
        questions: [
            {
                ...
                correct: 1,
                explanation: "The correct answer is Convert sugar to alcohol and CO2."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Conversion of sharp malic acid to softer lactic acid."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is Bâtonnage (lees stirring)."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Remove tartrate crystals that could form in bottle."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Egg whites."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is White wines are typically fermented without skins, red wines with skins for color and tannin extraction."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Aging on the lees (dead yeast)."
            },
            {
                ...
                correct: 2,
                explanation: "The correct answer is Saignée."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is 12-22°C (cooler to preserve aromatics)."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Add stalky, spicy aromatics and silky tannin texture."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is Reduce alcohol or remove excess water."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is French or American oak."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is American oak typically imparts more pronounced vanilla, coconut flavors."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Submerge the cap of skins to extract color, tannin, and flavor."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is Fermentation of whole, uncrushed grapes in CO2 atmosphere."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Add sugar before/during fermentation to increase alcohol."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Heating then rapidly cooling grapes to extract color and tannins."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Removing the sediment (lees) from the bottle neck."
            },
            {
                ...
                correct: 1,
                explanation: "The correct answer is Antioxidant and antimicrobial preservative."
            },
            {
                ...
                correct: 0,
                explanation: "The correct answer is Controlled addition of small amounts of oxygen to soften tannins."
            }
        ]
    },
        ...
        questions: [
            {
                ...
                correct: 1,
                explanation: "Wine should be stored at 10-15°C (50-59°F) - cool and constant. Higher temperatures accelerate aging; fluctuating temperatures can push wine past corks. Consistency is more important than the exact temperature."
            },
            {
                ...
                correct: 1,
                explanation: "Horizontal storage keeps the cork moist and expanded, preventing it from drying out and shrinking. A dried cork allows oxygen in, oxidizing the wine. This applies to natural cork; screwcaps can be stored upright."
            },
            {
                ...
                correct: 2,
                explanation: "Full-bodied reds like Cabernet and Syrah are best at 15-18°C (59-64°F), cooler than room temperature. This temperature showcases structure without muting aromatics or emphasizing alcohol."
            },
            {
                ...
                correct: 0,
                explanation: "Light whites and sparkling wines are best at 6-10°C (43-50°F) - well chilled. This preserves their fresh, crisp character, delicate aromatics, and prevents them from tasting flabby or losing fizz."
            },
            {
                ...
                correct: 1,
                explanation: "Decanting separates wine from sediment in older bottles and aerates young wines, softening tannins and opening up aromatics. It's beneficial for tannic young reds and aged wines with heavy sediment."
            },
            {
                ...
                correct: 1,
                explanation: "Young, tannic reds (Bordeaux, Barolo, Napa Cabernet) and old wines with sediment benefit most. Young wines need aeration to soften tannins; old wines need gentle separation from sediment before serving."
            },
            {
                ...
                correct: 1,
                explanation: "Cork taint is caused by TCA (2,4,6-trichloroanisole), a compound formed when natural fungi in cork come into contact with chlorine-based sterilizers. It can also spread through winery equipment and barrels."
            },
            {
                ...
                correct: 1,
                explanation: "Cork taint (TCA) smells like wet cardboard, musty basement, damp newspaper, or moldy attic. It strips wine of fruit aromas and makes it smell flat and musty. Even small amounts are noticeable."
            },
            {
                ...
                correct: 0,
                explanation: "Oxygen is wine's primary enemy in storage, causing oxidation that browns wine and creates stale, nutty, sherry-like flavors. Heat accelerates oxidation; proper closures and temperature control minimize oxygen exposure."
            },
            {
                ...
                correct: 1,
                explanation: "Ideal humidity is 60-70%. Too low (below 50%) dries corks, allowing oxygen in. Too high (above 80%) promotes mold on labels and corks, though it won't harm the wine itself."
            },
            {
                ...
                correct: 0,
                explanation: "UV light and heat from sunlight degrade wine, breaking down organic compounds and creating unpleasant flavors (lightstruck character). This is why wine bottles are often dark-colored and cellars are dark."
            },
            {
                ...
                correct: 1,
                explanation: "Larger bowl glasses for reds allow aeration and room to swirl, releasing complex aromas. Smaller glasses for whites preserve temperature and concentrate delicate aromatics. Shape directs wine to appropriate parts of tongue."
            },
            {
                ...
                correct: 1,
                explanation: "Flute or tulip glasses are ideal for sparkling wine - tall and narrow to preserve bubbles and concentrate aromatics. Wide coupes lose fizz quickly. The narrow shape maintains mousse and carbonation."
            },
            {
                ...
                correct: 1,
                explanation: "Open old reds 30 minutes to 1 hour before serving to check condition. Decant gently just before serving to separate from sediment. Old wines are fragile - excessive aeration can cause them to fade quickly."
            },
            {
                ...
                correct: 1,
                explanation: "Pour 50-75ml (1.5-2.5 oz) for tasting, about one-quarter to one-third of a standard wine glass. This allows enough wine to swirl and assess without overwhelming the taster or wasting wine."
            },
            {
                ...
                correct: 0,
                explanation: "Oxidized wine has been exposed to too much oxygen, turning brownish, losing fresh fruit character, and developing flat, stale, nutty, or sherry-like flavors. It's a fault unless intentional (Madeira, Sherry)."
            },
            {
                ...
                correct: 1,
                explanation: "Most wines deteriorate within 3-5 days of opening. Light whites and sparkling wines fade fastest (1-2 days); full-bodied reds last longest (3-5 days). Use recorking, refrigeration, and inert gas to extend life."
            },
            {
                ...
                correct: 0,
                explanation: "Vibration disturbs sediment, accelerates chemical reactions, and can prematurely age wine by disrupting the delicate aging process. Constant vibration from appliances or traffic should be avoided in long-term storage."
            },
            {
                ...
                correct: 1,
                explanation: "Aeration exposes wine to oxygen, softening harsh tannins, allowing volatile compounds to evaporate, and opening up aromas. Young, tannic reds benefit most; delicate old wines or aromatic whites can lose character."
            },
            {
                ...
                correct: 1,
                explanation: "Natural cork has the highest risk of cork taint (TCA), affecting 2-5% of bottles. Screwcaps and synthetic corks eliminate TCA risk but don't allow the same micro-oxygenation for aging."
            }
        ]
    },
        france: {
    ...
    california: {
        ...
        questions: [
            {
                q: "Which California region is coolest due to fog from the Pacific?",
                options: ["Napa Valley", "Carneros", "Paso Robles", "Alexander Valley"],
                correct: 1,
                explanation: "Carneros (Los Carneros) straddles Napa and Sonoma, heavily influenced by San Pablo Bay fog and cool breezes. This makes it ideal for Pinot Noir, Chardonnay, and sparkling wine production."
            },
            {
                q: "Napa Valley's most planted and iconic grape is what?",
                options: ["Pinot Noir", "Zinfandel", "Cabernet Sauvignon", "Merlot"],
                correct: 2,
                explanation: "Cabernet Sauvignon dominates Napa Valley, producing full-bodied, concentrated wines with black fruit, oak, and firm tannins. Premium bottlings from Rutherford, Oakville, and Stags Leap command high prices."
            },
            {
                q: "What is unique about Paso Robles' climate?",
                options: ["Coolest region", "Large diurnal temperature variation", "Constant fog", "High rainfall"],
                correct: 1,
                explanation: "Paso Robles experiences extreme diurnal shifts (40-50°F difference day/night), allowing full ripeness while retaining acidity. This benefits Rhône varieties, Cabernet Sauvignon, and Zinfandel."
            },
            {
                q: "Russian River Valley is most famous for which varieties?",
                options: ["Cabernet and Merlot", "Pinot Noir and Chardonnay", "Zinfandel and Petite Sirah", "Syrah and Grenache"],
                correct: 1,
                explanation: "Russian River Valley's cool, foggy climate makes it one of California's premier regions for elegant Pinot Noir and Chardonnay, with some top sparkling wine production as well."
            },
            {
                q: "What distinguishes Stag's Leap District Cabernet?",
                options: ["Heavy and tannic", "Elegant with velvety tannins", "Light-bodied", "High acidity"],
                correct: 1,
                explanation: "Stags Leap District (famous for the 1976 Judgment of Paris) produces Cabernet with distinctive elegance, silky tannins, and refined fruit - more finesse than power compared to other Napa sub-regions."
            },
            {
                q: "Old vine Zinfandel in California often comes from which region?",
                options: ["Napa Valley", "Dry Creek Valley/Lodi", "Santa Barbara", "Mendocino"],
                correct: 1,
                explanation: "Dry Creek Valley in Sonoma and Lodi have ancient Zinfandel plantings, some pre-Prohibition. These produce concentrated, jammy wines with high alcohol, spice, and blackberry fruit."
            },
            {
                q: "The Santa Rita Hills AVA is known for what?",
                options: ["Hot climate Zinfandel", "Cool climate Pinot Noir and Chardonnay", "Cabernet Sauvignon", "Sparkling wines only"],
                correct: 1,
                explanation: "Santa Rita Hills in Santa Barbara County has an east-west valley orientation funneling Pacific fog inland, creating ideal cool-climate conditions for Burgundian varieties."
            },
            {
                q: "What characterizes Howell Mountain Cabernet?",
                options: ["Light and fruity", "Powerful with mountain fruit character", "Sweet", "Sparkling"],
                correct: 1,
                explanation: "Howell Mountain (above the Napa fog line at 1,400+ ft elevation) produces powerful, structured Cabernets with concentrated dark fruit, firm tannins, and distinctive mountain character."
            },
            {
                q: "Anderson Valley is primarily known for what?",
                options: ["Cabernet Sauvignon", "Cool climate Pinot Noir and sparkling wines", "Zinfandel", "Petite Sirah"],
                correct: 1,
                explanation: "Anderson Valley in Mendocino is very cool due to maritime influence, making it excellent for Pinot Noir, Chardonnay, and high-quality Traditional Method sparkling wines."
            },
            {
                q: "Rutherford AVA is famous for what characteristic?",
                options: ["'Rutherford dust' in Cabernet", "Pinot Noir", "Sweet wines", "High acidity whites"],
                correct: 0,
                explanation: "'Rutherford dust' refers to a distinctive dusty, earthy tannin character in Cabernet Sauvignon from this gravelly, well-drained Napa sub-region."
            },
            {
                q: "What makes Sonoma Coast distinct from Sonoma Valley?",
                options: ["Warmer temperatures", "Direct Pacific influence and fog", "Higher elevation only", "Desert climate"],
                correct: 1,
                explanation: "Sonoma Coast is a large AVA spanning the Pacific coastline with strong maritime influence, fog, and cool temperatures, producing elegant Pinot Noir and Chardonnay."
            },
            {
                q: "Lodi is most associated with which grape variety?",
                options: ["Pinot Noir", "Chardonnay", "Zinfandel", "Riesling"],
                correct: 2,
                explanation: "Lodi in the Central Valley is 'Zinfandel capital,' with extensive old-vine plantings producing ripe, full-bodied wines. The region also grows many other varieties affordably."
            },
            {
                q: "Mount Veeder AVA wines are known for what?",
                options: ["Light, early-drinking wines", "Intense, age-worthy mountain wines", "Sparkling wines", "Rosé only"],
                correct: 1,
                explanation: "Mount Veeder (Mayacamas Mountains) produces intense, structured Cabernet and Zinfandel from high-elevation vineyards above the fog, with concentrated fruit and firm tannins."
            },
            {
                q: "Santa Maria Valley is ideal for which varieties?",
                options: ["Cabernet and Merlot", "Pinot Noir and Chardonnay", "Zinfandel", "Syrah only"],
                correct: 1,
                explanation: "Santa Maria Valley's east-west orientation funnels cool Pacific air inland, creating ideal conditions for Burgundian varieties, with some excellent Syrah from warmer sites."
            },
            {
                q: "What is distinctive about Oakville Cabernet?",
                options: ["Lightest Napa style", "Rich, concentrated with velvety tannins", "High acidity", "Sparkling"],
                correct: 1,
                explanation: "Oakville in central Napa Valley floor produces quintessential Napa Cabernet - rich, opulent, concentrated with ripe black fruit, integrated oak, and supple tannins."
            },
            {
                q: "Edna Valley is climatically similar to which region?",
                options: ["Paso Robles", "Napa Valley", "Carneros/cool maritime", "Central Valley"],
                correct: 2,
                explanation: "Edna Valley near San Luis Obispo has cool maritime influence and morning fog, making it excellent for Chardonnay and Pinot Noir with fresh acidity and elegance."
            },
            {
                q: "What makes Alexander Valley distinct?",
                options: ["Coolest Sonoma region", "Warmer than Russian River, good for Cabernet and Merlot", "High elevation only", "Coastal fog"],
                correct: 1,
                explanation: "Alexander Valley is warmer and less foggy than Russian River, producing excellent Cabernet Sauvignon, Merlot, and Zinfandel with ripe fruit and good structure."
            },
            {
                q: "Central Coast is known for what climate feature?",
                options: ["Desert heat", "Cool maritime influence from Pacific", "High altitude", "Extreme continental"],
                correct: 1,
                explanation: "Central Coast benefits from Pacific maritime influence through transverse valleys, creating cool microclimates ideal for Pinot Noir, Chardonnay, and Rhône varieties."
            },
            {
                q: "What distinguishes Sierra Foothills wines?",
                options: ["Sea-level vineyards", "High-elevation, old-vine Zinfandel", "Cool climate Pinot", "Sparkling only"],
                correct: 1,
                explanation: "Sierra Foothills (including Amador County) has historic high-elevation vineyards with old-vine Zinfandel producing concentrated, powerful wines, plus Italian varieties like Barbera."
            },
            {
                q: "Dry Creek Valley is particularly associated with which variety?",
                options: ["Pinot Noir", "Zinfandel", "Riesling", "Chardonnay"],
                correct: 1,
                explanation: "Dry Creek Valley in Sonoma is legendary for old-vine Zinfandel, producing ripe, spicy wines with blackberry fruit. The region also grows excellent Sauvignon Blanc."
            }
        ]
    },
    ...
    australia: {
        ...
        questions: [
            {
                q: "What is Australia's most planted red grape?",
                options: ["Cabernet Sauvignon", "Shiraz", "Merlot", "Pinot Noir"],
                correct: 1,
                explanation: "Shiraz is Australia's most planted and iconic red variety, producing diverse styles from elegant cool-climate to powerful warm-climate wines with blackberry, spice, and chocolate."
            },
            {
                q: "Barossa Valley is most famous for which style?",
                options: ["Elegant Pinot Noir", "Full-bodied, ripe Shiraz", "Crisp Riesling", "Sparkling wines"],
                correct: 1,
                explanation: "Barossa Valley produces Australia's most powerful Shiraz, often from old vines, with ripe blackberry, chocolate, sweet spice, and high alcohol (14-15%+)."
            },
            {
                q: "Which region is known for cool-climate Pinot Noir?",
                options: ["Barossa", "McLaren Vale", "Yarra Valley", "Hunter Valley"],
                correct: 2,
                explanation: "Yarra Valley in Victoria has a cool climate ideal for elegant Pinot Noir and Chardonnay, plus quality sparkling wines. It's often compared to Burgundy."
            },
            {
                q: "Margaret River is famous for what style of wine?",
                options: ["Shiraz only", "Bordeaux-style blends and Chardonnay", "Riesling", "Fortified"],
                correct: 1,
                explanation: "Margaret River in Western Australia is renowned for elegant Cabernet blends with Merlot, plus exceptional Chardonnay, benefiting from maritime influence."
            },
            {
                q: "What makes Hunter Valley Semillon unique?",
                options: ["Oak-aged and tropical", "Unoaked, high-acid, develops with age", "Sweet style", "Sparkling"],
                correct: 1,
                explanation: "Hunter Semillon is unique - unoaked, picked early with high acidity and low alcohol (10-11%), then aged in bottle to develop toast, honey, and waxy complexity."
            },
            {
                q: "Eden Valley is most associated with which variety?",
                options: ["Shiraz", "Riesling", "Cabernet", "Merlot"],
                correct: 1,
                explanation: "Eden Valley (adjacent to Barossa) at higher elevation is Australia's premier Riesling region, producing elegant, age-worthy wines with lime, toast, and petrol notes."
            },
            {
                q: "McLaren Vale is known for producing what?",
                options: ["Light Pinot Noir", "Rich Shiraz and GSM blends", "Riesling", "Sparkling wines"],
                correct: 1,
                explanation: "McLaren Vale near Adelaide produces powerful, ripe Shiraz and Grenache-Shiraz-Mourvèdre (GSM) blends with dark fruit, chocolate, and Mediterranean herb notes."
            },
            {
                q: "Coonawarra is famous for what soil type?",
                options: ["Slate", "Terra rossa over limestone", "Granite", "Sand"],
                correct: 1,
                explanation: "Coonawarra's distinctive terra rossa (red earth) over limestone produces elegant, structured Cabernet Sauvignon with mint, blackcurrant, and cedary oak character."
            },
            {
                q: "Tasmania is primarily known for what?",
                options: ["Full-bodied Shiraz", "Cool-climate Pinot Noir and sparkling wines", "Fortified wines", "Riesling"],
                correct: 1,
                explanation: "Tasmania's cool maritime climate produces elegant Pinot Noir, Chardonnay, and high-quality Traditional Method sparkling wines, similar to Champagne's climate."
            },
            {
                q: "What characterizes Clare Valley Riesling?",
                options: ["Sweet and low acid", "Dry with intense lime and aging potential", "Sparkling", "Oaked"],
                correct: 1,
                explanation: "Clare Valley Riesling is bone dry with piercing acidity, intense lime flavors, and remarkable aging ability (10-20+ years), developing toast and honey notes."
            },
            {
                q: "The 'SE Australia' zone allows what?",
                options: ["Single vineyard wines only", "Blending grapes from multiple states", "Organic certification", "Sparkling wines only"],
                correct: 1,
                explanation: "South Eastern Australia is a vast super-zone allowing blending across multiple states (Victoria, NSW, South Australia), used for consistent, value-oriented wines."
            },
            {
                q: "Adelaide Hills is known for producing what?",
                options: ["Full-bodied Shiraz", "Cool-climate Sauvignon Blanc and Chardonnay", "Fortified wines", "GSM blends"],
                correct: 1,
                explanation: "Adelaide Hills' elevation creates a cool climate ideal for crisp Sauvignon Blanc, elegant Chardonnay, Pinot Noir, and quality sparkling wines."
            },
            {
                q: "What makes Rutherglen Muscat special?",
                options: ["Dry and crisp", "Lusciously sweet, oxidatively aged fortified wine", "Sparkling", "Light and fresh"],
                correct: 1,
                explanation: "Rutherglen Muscat (often from Muscat à Petits Grains Rouge) is lusciously sweet and concentrated, aged oxidatively in a solera-like system, with intense raisin, toffee, and coffee flavors."
            },
            {
                q: "Mornington Peninsula specializes in which varieties?",
                options: ["Shiraz and Grenache", "Pinot Noir and Chardonnay", "Cabernet and Merlot", "Riesling"],
                correct: 1,
                explanation: "Mornington Peninsula's cool maritime climate south of Melbourne produces elegant, Burgundian-style Pinot Noir and Chardonnay with finesse and complexity."
            },
            {
                q: "What is unique about Hunter Valley's climate?",
                options: ["Cool and dry", "Warm and humid with vintage variation", "Mediterranean", "Alpine"],
                correct: 1,
                explanation: "Hunter Valley is warm and humid with high vintage variation due to harvest rain, presenting challenges for grape quality but producing unique Semillon and Shiraz styles."
            },
            {
                q: "Heathcote in Victoria is known for what?",
                options: ["Riesling", "Powerful Shiraz from Cambrian soils", "Pinot Noir", "Chardonnay"],
                correct: 1,
                explanation: "Heathcote produces powerful, structured Shiraz from ancient Cambrian red volcanic soils, with intense dark fruit, spice, and distinctive earthy minerality."
            },
            {
                q: "Great Southern in Western Australia is known for what?",
                options: ["Hot climate reds", "Cool-climate diversity (Riesling, Pinot, Shiraz)", "Sparkling wines only", "Fortified wines"],
                correct: 1,
                explanation: "Great Southern is a large, cool-climate region producing diverse wines including Riesling, elegant Shiraz, Pinot Noir, and Cabernet - one of Australia's most promising regions."
            },
            {
                q: "What does GI stand for in Australian wine law?",
                options: ["Grape Indication", "Geographic Indication", "Guaranteed Investment", "Grand Imperial"],
                correct: 1,
                explanation: "Geographic Indication (GI) is Australia's appellation system, with zones (largest), regions, and sub-regions. An 85% minimum rule applies for vintage, variety, and GI labeling."
            },
            {
                q: "Mudgee is known for what type of wines?",
                options: ["Sparkling", "Full-bodied reds (Shiraz, Cabernet)", "Riesling", "Pinot Noir"],
                correct: 1,
                explanation: "Mudgee in New South Wales' inland high-altitude continental climate produces full-bodied, concentrated Shiraz and Cabernet Sauvignon with ripe fruit and structure."
            },
            {
                q: "Orange in NSW is characterized by what?",
                options: ["Sea level vineyards", "High altitude (600-1,100m) cool climate wines", "Desert climate", "Tropical"],
                correct: 1,
                explanation: "Orange is a high-elevation region producing cool-climate wines with elegance and acidity, including Chardonnay, Sauvignon Blanc, Pinot Noir, and Shiraz."
            }
        ]
    },
    germany: {
